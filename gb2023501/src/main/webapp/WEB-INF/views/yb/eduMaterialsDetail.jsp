	        ...
	        <hr class="my-3">
	        	<table id="table">
					<tr>
						<th>자료구분</th>
						<c:choose>
							<c:when test="${eduMaterialsList.em_category  == 1}">	
								<td width="150px;">
				                    <input class="form-check-input" type="radio" name="em_type" id="em_typeTutorial" checked="checked">
				                    <label>튜토리얼</label>
				                </td>
				                <td width="150px;">   
							...
							<c:otherwise>
				                ...
				                <td width="150px;">   
				                    <input class="form-check-input" type="radio" name="em_type" id="em_typeVideo" checked="checked">
				                    <label>교육영상</label>
								</td>
								<td></td>
							</c:otherwise>
...
<!-- 		            </div> -->
		            <tr>
						<th>자료명</th>
						<td colspan="3">
		                    <input type="text" class="form-control" id="em_title" name="em_title" value="${eduMaterials.emTitle }">
<!-- 		                    <label for="subject">자료명</label> -->
					...
					<tr>
						<th>내용</th>
						<td colspan="3">
		                   	<textarea class="form-control" id="em_content" name="em_content" style="height: 200px">${eduMaterials.emContent }</textarea>
<!-- 		                       <label for="message">내용</label> -->
		            ...
		            <tr>
						<th>자료주소</th>
						<td colspan="3">
		                    <input type="text" class="form-control" id="em_data_addr" name="em_data_addr" value="${eduMaterials.emDataAddr }">
		                </td>
					</tr>
	                <tr>
	                	<th>썸네일</th>
