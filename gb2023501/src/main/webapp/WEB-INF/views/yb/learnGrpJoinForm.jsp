	...
	<div class="col-lg-11 wow fadeInUp" data-wow-delay="0.5s">
		...
		<form action="/learning/searchGrpList" method="post">
			<div class="input-group col-md-5 mb-3"> 
				<!-- 카테고리 분류 -->
				<select name="searchType" id="searchType" class="w-17 rounded" style="margin-right: 10px; border-color: #ced4da" onchange="selectType()">
					<option value="lgTitle">그룹명</option>
					<option value="mmName">교육자명</option>
				</select>
				<select name="lgTitle" id="lgTitle" class="w-17 rounded" style="margin-right: 5px; border-color: #ced4da" required>
	            ...
	            <input class="btn rounded py-2 px-3" type="submit" style="background: #263d94; color: white;" value="조회">
